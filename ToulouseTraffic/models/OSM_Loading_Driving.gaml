...
global {
  ...
  string directory <- "full_shapefiles";
  string building_shapefile_name <- "buildings.shp";
  string roads_shapefile_name <- "roads.shp";
  ...
  //OSM file to load
  file<geometry> osmfile <- osm_file("../../includes/" + directory + "/" + building_shapefile_name, filtering);
